...
, {"~Xs","~Xs",1, 51, "MXs","0",0,1,1,0}
, {"~YF3u1","~YF3u1~",0, 5920002, "MYF3u1","WYF3u1",1,3,6,2}
};
...
,"ymm","ymtau","cabi","lamF3u","MZ","Me","MMU","MTA","MU","MC"
,"MT","MD","MS","MB","MH","MXs","MYF3u1","E","Pi","aEW"
,"MW"};
...
,  1.056600E-01,  1.777000E+00,  2.277360E-01,  2.300000E-01,  9.118760E+01,  5.110000E-04,  1.056600E-01,  1.777000E+00,  2.550000E-03,  1.270000E+00
,  1.720000E+02,  5.040000E-03,  1.010000E-01,  4.700000E+00,  1.250000E+02,  1.100000E+01,  4.000000E+03,  2.718282E+00,  3.141593E+00};
...
int calcMainFunc(void)
{
  ...
  cErr=1;
   ...
   nCurrentVars=30;
   V[30]=Pow(Pow(V[14],2)/(2.)+Pow(Pow(V[14],4)/(4.)-V[29]*V[28]*Pow(2,-0.5)*Pow(V[1],-1)*Pow(V[14],2),0.5),0.5);
