...
{  int err;
  ...
  */
  ...
  double MXw, MYF3Qu3, MYF3Qd3, lamF3Q, delta_small;
  MXw = 1000.; // DM mass in GeV
  delta_small = 5.e-3; // Mass splitting between DM and mediator
  MYF3Qu3 = MXw*(1. + delta_small); // Mediator mass to top in GeV
  MYF3Qd3 = MXw*(1. + delta_small); // Mediator mass to bottom in GeV
  lamF3Q = 0.01; // t-channel Yukawa coupling (taken to be flavor universal here)

  assignValW("lamF3Q", lamF3Q); // Yukawa coupling to up
	assignValW("MXw", MXw); // DM mass in GeV
	assignValW("MYF3Qu3", MYF3Qu3); // Mediator mass in GeV
	assignValW("MYF3Qd3", MYF3Qd3); // Mediator mass in GeV
