...
, {"~Xw","~Xw~",0, 58, "MXw","0",2,1,3,0}
, {"~YF3Qu3","~YF3Qu3~",0, 5910006, "MYF3Qu3","WYF3Qu3",1,3,6,2}
, {"~YF3Qd3","~YF3Qd3~",0, 5910005, "MYF3Qd3","WYF3Qd3",1,3,6,-1}
};
...
,"ymm","ymtau","cabi","lamF3Q","MZ","Me","MMU","MTA","MU","MC"
,"MT","MD","MS","MB","MH","MXw","MYF3Qu3","MYF3Qd3","E","Pi"
,"aEW","MW"};
...
,  1.056600E-01,  1.777000E+00,  2.277360E-01,  2.200000E-01,  9.118760E+01,  5.110000E-04,  1.056600E-01,  1.777000E+00,  2.550000E-03,  1.270000E+00
,  1.720000E+02,  5.040000E-03,  1.010000E-01,  4.700000E+00,  1.250000E+02,  1.500000E+01,  3.002000E+03,  3.005000E+03,  2.718282E+00,  3.141593E+00
};
...
int calcMainFunc(void)
{
  ...
  cErr=1;
   ...
   nCurrentVars=31;
   V[31]=Pow(Pow(V[14],2)/(2.)+Pow(Pow(V[14],4)/(4.)-V[30]*V[29]*Pow(2,-0.5)*Pow(V[1],-1)*Pow(V[14],2),0.5),0.5);
