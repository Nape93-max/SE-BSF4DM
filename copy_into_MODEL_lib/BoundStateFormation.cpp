...
int bsf_scenario = 1; //Flag for BSF (0 = no BSF, 1 = no transition limit, 2 = efficient transition limit, 3 = ionization equilibrium, 4 = Full matrix solution)
int num_excited_states = 1; //Number of n states included in the calculation (n = 0 -> no bound states, n = 1 -> ground state etc.)
